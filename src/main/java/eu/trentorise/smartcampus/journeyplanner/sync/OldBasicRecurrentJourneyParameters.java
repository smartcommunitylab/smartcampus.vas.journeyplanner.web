...
public class OldBasicRecurrentJourneyParameters extends BasicObject {

	private String clientId;
	private String name;
	private OldRecurrentJourneyParameters data;
	...
	public OldRecurrentJourneyParameters getData() {
		return data;
	}

	public void setData(OldRecurrentJourneyParameters content) {
		this.data = content;
	}
